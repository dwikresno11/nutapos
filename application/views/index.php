	...
	<div class="container"><br/>
						...
						<div class="col-md-4">
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<div class="row">
										<div class="col-md-7">
											<h4><?php echo 'Rp '.number_format($row->SellPrice);?></h4>
										</div>
										<div class="col-md-5">
											<input type="number" name="quantity" id="<?php echo $row->ItemID;?>" value="1" class="quantity form-control">
										</div>
									</div>
									<button class="add_cart btn btn-success btn-block" data-produkid="<?php echo $row->ItemID;?>" data-produknama="<?php echo $row->ItemName;?>" data-produkharga="<?php echo $row->SellPrice;?>">Add To Cart</button>
								</div>
							</div>
						</div>
					<?php endforeach;?>
					...
					<div class="col-md-12">
						<!-- <form action="/"> -->
							...
							<div class="form-group">
								...
								<input type="number" class="form-control" id="kembali" readonly="true">
							</div>
		...
		$('#simpan').click(function(){
			...
			if(bayar!="" && kembali>0){
				...
				$.ajax({
					url : "<?php echo base_url();?>home/get_all_data",
					method : "POST",
					data : {nama : nama,tanggal,tanggal,jam:jam,bayar:bayar,kembali:kembali},
					success :function(data){
						console.log(data)
					}
				});
